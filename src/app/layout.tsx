...
export const metadata: Metadata = {
  ...
  icons: {
    icon: "/2026/RAIZ_logo SITE+PINTRST.png?v=1",
    shortcut: "/2026/RAIZ_logo SITE+PINTRST.png?v=1",
  },
  openGraph: {
    title: "RAIZ Interiors | Interior Design Studio",
  ...
  return (
    <html lang={documentLang} className="scroll-smooth" suppressHydrationWarning>
      <head>
        ...
        <link rel="icon" href="/2026/RAIZ_logo SITE+PINTRST.png?v=1" type="image/png" />
        <link rel="shortcut icon" href="/2026/RAIZ_logo SITE+PINTRST.png?v=1" type="image/png" />
      </head>
      <body
